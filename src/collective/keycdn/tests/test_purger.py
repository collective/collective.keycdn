...
class TestKeycdnPurger(unittest.TestCase):
    ...
    def test_purge_async_queues(self):
        ...
        with mock.patch.object(self.purger, '_ensure_worker'):
            ...
            self.assertFalse(self.purger.queue.empty(), "Queue should not be empty after purgeAsync")
    ...
    def test_purge_disabled(self):
        ...
        with mock.patch('collective.keycdn.purger.ORIGINAL_DEFAULT_PURGER.purgeSync') as mock_purge:
    ...
    def test_purge_async_delegates_when_disabled(self):
        ...
        with mock.patch('collective.keycdn.purger.ORIGINAL_DEFAULT_PURGER.purgeAsync') as mock_purge:
            self.purger.purgeAsync('/test-page')
